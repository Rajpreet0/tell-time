...
const Sidebar = () => {
  ...
  return (
    <div className='z-10 h-full bg-[#112936] drop-shadow-xl lg:w-[20%] flex flex-col'>
        <div className='w-full p-8 flex flex-row items-center justify-center'>
            ...
            <p className='text-white font-semibold font-xl pl-4'>{user?.name}</p>
        </div>
        <hr/>
        <div className='flex flex-col justify-between flex-grow'>
            ...
            <div onClick={() => signOut()} className=' w-full p-4'>
